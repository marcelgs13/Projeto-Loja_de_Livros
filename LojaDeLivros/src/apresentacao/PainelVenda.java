    ...
    private void adicionarItem() {
        ...
        try {
            ...
            if (livro.getQuantidadeEstoque() < quantidade) {
                JOptionPane.showMessageDialog(this, "Estoque insuficiente. Disponível: " + livro.getQuantidadeEstoque(), "Erro", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            JOptionPane.showMessageDialog(this, "ID do Livro e Quantidade devem ser números inteiros.", "Erro", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void finalizarVenda() {
        ...
        try {
            ...
            if (UtilitarioArquivo.salvarConteudo(nomeArquivoTxt, fatura)) {
                JOptionPane.showMessageDialog(this, "Fatura salva como: " + nomeArquivoTxt, "Geração de Arquivo", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "Erro ao salvar a fatura em arquivo.", "Erro", JOptionPane.ERROR_MESSAGE);
            }
            JOptionPane.showMessageDialog(this, "Venda finalizada com sucesso! Fatura emitida.", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
