...
public class PainelCliente extends JPanel {
    ...
    private void modificarCliente() {
        if (campoId.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Selecione um cliente na tabela ou preencha o ID para modificar.", "Erro", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (clienteModificado != null) {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Cliente modificado com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
                limparCampos();
                carregarTabela();
            } catch (IllegalArgumentException ex) {
                JOptionPane.showMessageDialog(this, ex.getMessage(), "Erro de Negócio", JOptionPane.ERROR_MESSAGE);
    ...
    private void apagarCliente() {
        if (campoId.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Selecione um cliente na tabela ou preencha o ID para apagar.", "Erro", JOptionPane.ERROR_MESSAGE);
            return;
        }
        try {
            int id = Integer.parseInt(campoId.getText());
            int confirmacao = JOptionPane.showConfirmDialog(this, "Tem certeza que deseja apagar o cliente ID: " + id + "?", "Confirmação", JOptionPane.YES_NO_OPTION);
