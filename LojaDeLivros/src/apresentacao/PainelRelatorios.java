...
public class PainelRelatorios extends JPanel {
    ...
    private void gerarRelatorios() {
        ...
        sb.append(maisVendido != null ? String.format("   - Título: %s (ID: %d)\n\n", maisVendido.getTitulo(), maisVendido.getId()) : "   - Nenhum livro vendido.\n\n");

        // 3. Produto menos vendido
        Livro menosVendido = servicoVenda.produtoMenosVendido();
        sb.append("3. Produto Menos Vendido:\n");
        sb.append(menosVendido != null ? String.format("   - Título: %s (ID: %d)\n\n", menosVendido.getTitulo(), menosVendido.getId()) : "   - Nenhum livro vendido.\n\n");
        ...
        sb.append(diaMaisVendas != null ? String.format("   - Data: %s\n\n", diaMaisVendas.format(formatador)) : "   - Nenhuma venda registrada.\n\n");
